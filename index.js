...
//STATUS///
    const randomStatus = () => {
        let status = ["For TKE","WITH BANS","Dev: Jordaar#5819" ] //You can change the things within bracket.
        let rstatus = Math.floor(Math.random() * status.length);  //to anything you want
        bot.user.setActivity(status[rstatus], {type: "PLAYING"});
        }; setInterval(randomStatus, 20000)     //Playing can be changed to Watching & Listening
////////////////////////////////////////////////////////////////////////////////////////////////////
...
//It will process env for Bot's Token